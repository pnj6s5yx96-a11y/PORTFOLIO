...
site_header($post['title'], $post['description'], '/blog.php', ['canonical'=>$canonical,'alternates'=>['fr'=>$canonical,'en'=>site_url('en/article.php?slug='.rawurlencode($slug))],'schema_extra'=>[$schema]]);
